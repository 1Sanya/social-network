...
const FriendItem: FC<FriendsItemProps> = (props) => (
  <div className={s.wrapper}>
    <a href={String(props.id)}><img className={s.ava} src={String(props.img)} alt="" /></a>

    <div className={s.elsePhotoWr}>
      <div className={s.info}>
        <a className={s.name} href={String(props.id)}>{props.name}</a>
